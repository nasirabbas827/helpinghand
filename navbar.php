<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="home.php">Helping Hands</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
                ...
                echo '<li class="nav-item"><a class="nav-link" href="donation_history.php">My Donation History</a></li>';
                ...
                echo '<li class="nav-item"><a class="nav-link" href="user_reviews.php">My Reviews</a></li>';
