<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="admin_users.php">View Users</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_categories.php">Add Categories</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_centers.php">Add Donation Centers</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="admin_donations.php">View Donations</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="admin_reviews.php">User Reviews</a>
      </li>
      <li class="nav-item ">
